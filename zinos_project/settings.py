"""
Django settings for zinos_project project.
...
SECRET_KEY = 'django-insecure--u(v!^p00o!=8vh$gmjaxb0cv5=_&5t&in53oa7sn(zqvc%8p*'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'templates')],  # أضف هذا السطر
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'zinos_project.wsgi.application'
...
# اسمح بجميع الـ Hosts (للأغراض الاختبارية فقط)
ALLOWED_HOSTS = ['*']
